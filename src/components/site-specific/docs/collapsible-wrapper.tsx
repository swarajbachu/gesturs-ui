    ...
    <Collapsible open={isOpened} onOpenChange={setIsOpened}>
      <div className={cn("relative overflow-hidden rounded-md", className)} {...props}>
        ...
        >
          <div
            className={cn(
              "[&_pre]:my-0 [&_pre]:max-h-[650px] [&_pre]:pb-[100px] overflow-scroll [&_pre]:rounded-md"
            )}
          >
            {children}
          </div>
        ...
        <div
          className={cn(
            "absolute rounded-md  flex items-center justify-center bg-gradient-to-b from-background/10 to-background to-90% p-2",
