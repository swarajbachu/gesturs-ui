...
Gesturs UI is a collection of reusable components that you can copy and paste into your web apps. It primarily features components, blocks, and templates geared towards creating landing pages and user-facing marketing materials.
...
A great example of this in play is the [Linear](https://linear.app) landing page which I first came across in 2020. I didn't even need to try the product but I already knew that it _must_ be good.

This library is heavily inspired by [shadcn](https://ui.shadcn.com).

## Features

Gesturs UI components are built upon React Aria, making them super accessible and scalable.
